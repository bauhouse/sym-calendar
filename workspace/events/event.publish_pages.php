<?php
	...
	Class eventpublish_pages extends Event{
		
		const ROOTELEMENT = 'publish-pages';
		...
		public static function about(){
			return array(
					 ...
					 'version' => '1.0',
					 'release-date' => '2008-03-28T13:45:12+00:00',
					 'trigger-condition' => 'action[publish-pages]');	
		}
        ...
        <pre class="XML"><code>&lt;publish-pages>
  &lt;entry index="0" result="success" type="create | edit">
    &lt;message>Entry [created | edited] successfully.&lt;/message>
  &lt;/entry>
&lt;/publish-pages></code></pre>
...
&lt;/publish-pages></code></pre>
        ...
        <pre class="XML"><code>&lt;publish-pages result="error">
  &lt;message>Entry encountered errors when saving.&lt;/message>
...
&lt;/publish-pages></code></pre>
  ...
  &lt;/label>
  &lt;input name="action[publish-pages]" type="submit" value="Submit" />
&lt;/form></code></pre>
		...
		public function load(){			
			if(isset($_POST['action']['publish-pages'])) return $this->__trigger();
		}
